-- THE LOOP — Lecture / validation des avantages en attente par le partenaire (scan QR)
-- Contourne les RLS qui empêchent un partenaire authentifié de lire les octrois du membre.
