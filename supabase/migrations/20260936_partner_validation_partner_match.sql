-- Validation partenaire : élargir le rapprochement redemption ↔ code scanné
-- (code normalisé, établissement, compte user partenaire). Corrige le cas mobile
-- où la demande est visible (list_member_pending) mais apply_partner_benefit_validation = 0.
