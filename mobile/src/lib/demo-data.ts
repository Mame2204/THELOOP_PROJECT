...
function getApprovedPublicEvents(): Event[] {
  return [];
}

function getApprovedPublicLocations(): HomeLocation[] {
  return [];
}
...
export interface HomeLocation extends Location {
  ...
  /** Nombre d'étoiles effectif (auto ou override admin). */
  starCount?: number;
  ...
  /** Organisateur / exploitant affiché (optionnel). */
...
function organizerFor(id: string): string | null {
  return EVENT_ORGANIZERS[id] ?? null;
}
...
const _DEMO_EVENTS = [
  {
    ...
    galleryImages: [
      ...
      'https://images.unsplash.com/photo-1505373877841-8d25f0901faa?w=800&q=80',
    ...
    organizerName: organizerFor('evt-1'),
  ...
  },
  {
    ...
    partnerId: null,
    clickCount: 987,
    organizerName: organizerFor('evt-5'),
  ...
  },
  {
    ...
    partnerId: null,
    clickCount: 612,
    organizerName: organizerFor('evt-3'),
  ...
  },
  {
    ...
    partnerId: null,
    clickCount: 488,
    organizerName: organizerFor('evt-4'),
