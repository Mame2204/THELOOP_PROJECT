...
export const SUPPORT_PHONE_DISPLAY = '+224 626 68 06 06';
export const SUPPORT_PHONE_E164 = '+224626680606';
export const SUPPORT_PHONE_TEL_URL = `tel:${SUPPORT_PHONE_E164}`;

/** WhatsApp (même numéro, sans +). */
export const SUPPORT_WHATSAPP_TEL = '224626680606';
export const SUPPORT_WHATSAPP_URL = `https://wa.me/${SUPPORT_WHATSAPP_TEL}`;
